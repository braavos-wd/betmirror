...
function saveUser(userId: string, data: any) {
...
// 1. Check Status / Init
app.post('/api/wallet/status', (req: any, res: any) => {
...
app.post('/api/wallet/activate', (req: any, res: any) => {
...
app.get('/api/stats/global', (req: any, res: any) => {
    const users = loadUsers();
...
app.get('/api/bot/status/:userId', (req: any, res: any) => {
